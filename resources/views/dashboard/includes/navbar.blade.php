  ...
  <!-- Sidebar -->
  <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" style="scrollbar-width: none; -ms-overflow-style: none;" data-simplebar="init">
                    ...
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.004 3.5L2 6.689l5.004 3.191L2 13.063 7.004 16.5l5.006-3.188L17 16.5l5.004-3.188L17 10.006l5.004-3.187L17 3.5l-4.996 3.187L7.004 3.5zM2 16.689l5.004 3.188 4.996-3.188-5.004-3.187L2 16.689zm10 0l4.996 3.188 5.004-3.188-4.996-3.187L12 16.689z"></path>
                              </svg>
                        </span>
