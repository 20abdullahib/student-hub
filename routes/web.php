...
Route::get('/dashboard/dropbox', [DropboxController::class, 'showForm'])->name('dropbox.form');
Route::post('/dashboard/dropbox/setup', [DropboxController::class, 'setupAccount'])->name('dropbox.setup');
Route::get('/dropbox/files', [DropboxController::class, 'showFiles'])->name('dropbox.files');
Route::get('/dropbox/check', [DropboxController::class, 'checkAndRefreshAccessToken']);
Route::get('/dropbox/refresh-tokens', [DropboxController::class, 'refreshAllTokens']);
Route::get('/dropbox/access-token', [DropboxController::class, 'getAccessToken'])->name('dropbox.accessToken');
Route::get('/dropbox/file-link', [DropboxController::class, 'getSharedLink'])->name('dropbox.fileLink');
Route::post('/dropbox/update', [DropboxController::class, 'updateDropbox']);

Route::get('/dashboard/dropbox/upload/form', [DropboxController::class, 'showUploadForm'])->name('upload.form');
Route::post('/dashboard/dropbox/file-details', [DropboxController::class, 'storeFileDetails'])->name('file.details.store');
Route::get('/dashboard/dropbox/get-account-for-upload', [DropboxController::class, 'getAccountForUpload']);
